...
router.put('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex', programController.updateWorkoutInWeek);

// Route to delete a workout from a specific week
router.delete('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex', programController.deleteWorkoutFromWeek);
...
router.put('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex/stations/:stationIndex', programController.updateStationInWorkout);

// Route to delete a station from a workout
router.delete('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex/stations/:stationIndex', programController.deleteStationFromWorkout);
...
router.put('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex/stations/:stationIndex/sets/:setIndex', programController.updateSetInStation);

// Route to delete a set from a station
router.delete('/programs/:programId/weeks/:weekNumber/workouts/:workoutIndex/stations/:stationIndex/sets/:setIndex', programController.deleteSetFromStation);
